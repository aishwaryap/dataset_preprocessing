...
python3 extract_resnet_fcn_features.py \
    ...
    --image-list-file=referit_val_imlist.txt \
    --output-file=referit_val_imlist.hdf5 \
    > /scratch/cluster/aish/ReferIt/bash_log/resnet_fcn_features/val.out \
    2> /scratch/cluster/aish/ReferIt/bash_log/resnet_fcn_features/val.err
deactivate
