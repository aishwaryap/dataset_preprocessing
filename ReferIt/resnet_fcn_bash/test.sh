...
python3 extract_resnet_fcn_features.py \
    ...
    --image-list-file=referit_test_imlist.txt \
    --output-file=referit_test_imlist.hdf5 \
    > /scratch/cluster/aish/ReferIt/bash_log/resnet_fcn_features/test.out \
    2> /scratch/cluster/aish/ReferIt/bash_log/resnet_fcn_features/test.err
deactivate
