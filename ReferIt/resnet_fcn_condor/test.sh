...
request_GPUs = 1
+GPUJob = true
Log = /scratch/cluster/aish/ReferIt/condor_log/resnet_fcn/test.log
Error = /scratch/cluster/aish/ReferIt/condor_log/resnet_fcn/test.err
Output = /scratch/cluster/aish/ReferIt/condor_log/resnet_fcn/test.out
